...
void setup() 
{
  ...
  myPort = new Serial(this, "COM3", 115200); //38400);  
...
//        q[3] = decodeFloat(inputStringArr[3]);
        float f0 = Float.valueOf((inputStringArr[0])).floatValue();
        float f1 = Float.valueOf((inputStringArr[1])).floatValue();
        float f2 = Float.valueOf((inputStringArr[2])).floatValue();
        float f3 = Float.valueOf((inputStringArr[3])).floatValue();
        q[0] = f0;
        q[1] = f1;
        q[2] = f2;
        q[3] = f3;
